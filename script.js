...
async function generateQuestions() {
  ...
  for (let i = 0; i < count; i++) {
    try {
          ...
          contents: [
            {
              parts: [
                {
                  text: `Tạo một câu hỏi trắc nghiệm khác nhau về chủ đề: ${topic}. 
                        Câu hỏi có 4 phương án trả lời (A, B, C, D), trong đó chỉ có 1 đáp án đúng. 
                        Định dạng:
                        Câu hỏi: <câu hỏi>
                        A. <đáp án A>
                        B. <đáp án B>
      ...
      const questionObj = parseQuestion(content)
